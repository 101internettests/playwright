...
def test_operator_sbermobile_ratesmobile(page: Page):
    page.goto('https://www.moskvaonline.ru/balashiha/operatory/sbermobile/ratesmobile')
    check_header_operator_page(page)
    footer_mol(page)
    check_header_balashixa(page)
    expect(page.get_by_role("link", name="Подключить интернет")).to_be_visible()
    expect(page.locator('//span[contains(text(), "Мобильные операторы")]')).to_be_visible()
    expect(page.locator('//span[contains(text(), "СберМобайл")]')).to_be_visible()
    expect(page.locator('//span[contains(text(), "Тарифы")]')).to_be_visible()
    expect(page.locator('//img[@itemprop="contentUrl"]')).to_be_visible()
    expect(page.locator("#operator_banner").get_by_text("Подключение")).to_be_visible()
    expect(page.locator('(//a[contains(text(), "+7  (499)  651-44-44")])[1]')).to_be_visible()
...
def test_operator_sbermobile_ratesmobile_perenos_nomera(page: Page):
    page.goto('https://www.moskvaonline.ru/balashiha/operatory/sbermobile/ratesmobile/perenos_nomera')
    check_header_operator_page(page)
    footer_mol(page)
    check_header_balashixa(page)
    expect(page.get_by_role("link", name="Подключить интернет")).to_be_visible()
...
def test_operator_sbermobile_ratesmobile_esim(page: Page):
    page.goto('https://www.moskvaonline.ru/balashiha/operatory/sbermobile/ratesmobile/esim')
    check_header_operator_page(page)
    footer_mol(page)
    check_header_balashixa(page)
    expect(page.get_by_role("link", name="Подключить интернет")).to_be_visible()
...
def test_operator_sbermobile_ratesmobile_detskie(page: Page):
    urls = [
        'https://www.moskvaonline.ru/balashiha/operatory/sbermobile/ratesmobile/po-rossii',
        'https://www.moskvaonline.ru/balashiha/operatory/sbermobile/ratesmobile/detskie'
    ]
    for url in urls:
        page.goto(url)
    check_header_operator_page(page)
...
def test_operator_sbermobile_ratesmobile_vygodnye(page: Page):
    page.goto('https://www.moskvaonline.ru/balashiha/operatory/sbermobile/ratesmobile/vygodnye')
    check_header_operator_page(page)
    footer_mol(page)
    check_header_balashixa(page)
    expect(page.get_by_role("link", name="Подключить интернет")).to_be_visible()
